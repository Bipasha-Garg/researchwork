...
//   // Automatically fetch and process data when component mounts
//   useEffect(() => {
...
//   const processDefaultDataset = async () => {
//     setIsLoading(true);
//     setError(null);
...
//         {/* Left Dashboard */}
//         <div className="w-full lg:w-1/4 p-4 bg-white shadow rounded-lg min-w-[250px]">
//           <h1 className="text-lg sm:text-xl font-bold mb-4">Dataset Visualization</h1>
//           <div className="mb-4">
//             <div className="p-2 bg-blue-50 rounded">
//               <span className="font-semibold">Using default dataset: dataset.csv</span>
//             </div>
//           </div>
//           <button
//             type="button"
//             onClick={processDefaultDataset}
//             disabled={isLoading}
//             className="bg-blue-500 text-white px-4 py-2 rounded w-full text-sm sm:text-base disabled:bg-gray-400"
//           >
//             {isLoading ? "Processing..." : "Reload Visualization"}
//           </button>
//           {error && <div className="mt-2 text-red-500 text-sm">{error}</div>}
